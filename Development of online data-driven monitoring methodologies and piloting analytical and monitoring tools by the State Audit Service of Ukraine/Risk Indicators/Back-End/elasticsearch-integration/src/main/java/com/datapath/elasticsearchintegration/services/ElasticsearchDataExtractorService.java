...
public class ElasticsearchDataExtractorService extends BaseDataExtractor {
    ...
    private final TenderDataUpdater tenderDataUpdater;
    ...
    public void updateProcedureLogType(String tenderOuterId, String procedureLogType) {
        tenderDataUpdater.updateProcedureLogType(tenderOuterId, procedureLogType);
    }

    public void updateFeedbackStatuses(String tenderOuterId, String feedbackStatuses) {
        tenderDataUpdater.updateFeedbackStatuses(tenderOuterId, feedbackStatuses);
    }

    public String getLastTenderDate() {
        return procedureFilterService.getLastTenderDate();
    }
}
